...
\solution \\
Let X=\cbrak{0} be a random variable which represents the 4-digit number formed from the digits 0,1,3,5 and 7.\\\\
...
\begin{align}
\pr{\frac{\brak{X = 0} \cap \brak{X = 1}}{\brak{Y = 0}}}
\end{align}
...
\begin{align}
\Rightarrow \pr{\frac{\brak{X = 0} \cap \brak{X = 1}}{\brak{Y = 0}}} & = \frac{\brak{2 \times 5 \times 5 \times 2 - 1}}{\brak{2 \times 5 \times 5 \times 5 - 1}}\\ & = \frac{99}{249}.
\end{align}
...
\begin{align}
\pr{\frac{\brak{X = 0} \cap \brak{X = 1}}{\brak{Y = 1}}}
\end{align}
...
\begin{align}
\Rightarrow \pr{\frac{\brak{X = 0} \cap \brak{X = 1}}{\brak{Y = 1}}} & = \frac{6 + 6 + 6}{2 \times 4 \times 3 \times 2}\\ & = \frac{18}{48}\\ & = \frac{3}{8}.
\end{align}
}
